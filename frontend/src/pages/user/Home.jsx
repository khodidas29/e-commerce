            ...
            <div className="relative w-full h-[70vh] md:h-screen">
                ...
                <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20">
                    ...
                    <p className="text-white text-sm sm:text-lg md:text-2xl font-serif leading-relaxed max-w-2xl">
                        Your one-stop destination for online shopping. <br />
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    {categories.map((category) => (
                        ...
                        <button
                            ...
                            className={`
                px-6 py-3 rounded-2xl font-medium text-sm md:text-base
                transition-all duration-300 border

                ${selectedCategory === category
                                    ? "bg-linear-to-r from-blue-500 to-indigo-600 text-white shadow-lg scale-105 border-transparent"
